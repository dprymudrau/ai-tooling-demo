...
public class LoginPage extends AbstractPage {
    ...
    public static final String LOGIN_PAGE_URL = "https://www.underarmour.com/en-us/login";

    @FindBy(xpath = "//h1//img[@alt='us-web logo']")
    ...
    private ExtendedWebElement showPasswordToggle;
    ...
    public ExtendedWebElement getShowPasswordToggle() {
